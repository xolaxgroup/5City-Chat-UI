window.APP = {
  ...
  methods: {
    ...
    ON_CLOSE({ clearMessage }) {
      console.log(clearMessage);
      this.hideInput(true, clearMessage)
    },
    ...
    autocomplete() {
      let firstSuggestion = this.backingSuggestions.filter((el) => el.name.toLowerCase().match(this.message.toLowerCase()))[0];
